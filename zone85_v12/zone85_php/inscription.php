          ...
          <div class="clan-option" onclick="selectClan('bocage',this)">
            ...
            <div class="clan-info">
              ...
              <div class="clan-stats-mini">
                ...
                <?php if (!empty($bocage['members_count'])): ?><span class="clan-stat-mini"><strong><?= (int)$bocage['members_count'] ?></strong> membres</span><?php endif; ?>
                <?php if (!empty($bocage['season_score'])): ?><span class="clan-stat-mini"><strong><?= number_format((int)$bocage['season_score'],0,',',' ') ?> pts</strong></span><?php endif; ?>
                <?php if (!empty($bocage['trophies'])): ?><span class="clan-stat-mini"><strong><?= (int)$bocage['trophies'] ?></strong> trophée<?= $bocage['trophies']>1?'s':'' ?></span><?php endif; ?>
              </div>
            </div>
          ...
          <div class="clan-option" onclick="selectClan('littoral',this)">
            ...
            <div class="clan-info">
              ...
              <div class="clan-stats-mini">
                ...
                <?php if (!empty($littoral['members_count'])): ?><span class="clan-stat-mini"><strong><?= (int)$littoral['members_count'] ?></strong> membres</span><?php endif; ?>
                <?php if (!empty($littoral['season_score'])): ?><span class="clan-stat-mini"><strong><?= number_format((int)$littoral['season_score'],0,',',' ') ?> pts</strong></span><?php endif; ?>
                <?php if (!empty($littoral['trophies'])): ?><span class="clan-stat-mini"><strong><?= (int)$littoral['trophies'] ?></strong> trophée<?= $littoral['trophies']>1?'s':'' ?></span><?php endif; ?>
              </div>
            </div>
            <div class="clan-radio"></div>
          </div>
          ...
          <div class="clan-option" onclick="selectClan('marais',this)">
            ...
            <div class="clan-info">
              ...
              <div class="clan-stats-mini">
                ...
                <?php if (!empty($marais['members_count'])): ?><span class="clan-stat-mini"><strong><?= (int)$marais['members_count'] ?></strong> membres</span><?php endif; ?>
                <?php if (!empty($marais['season_score'])): ?><span class="clan-stat-mini"><strong><?= number_format((int)$marais['season_score'],0,',',' ') ?> pts</strong></span><?php endif; ?>
                <?php if (!empty($marais['trophies'])): ?><span class="clan-stat-mini"><strong><?= (int)$marais['trophies'] ?></strong> trophée<?= $marais['trophies']>1?'s':'' ?></span><?php endif; ?>
              </div>
            </div>
            <div class="clan-radio"></div>
          </div>
...
async function validateStep5() {
  ...
  try {
    ...
    if (json.ok) {
      ...
      // Afficher le modal PWA après inscription
      setTimeout(function() {
      if (window.Zone85PWA && !Zone85PWA.isInstalled()) {
          Zone85PWA.showModal();
        }
      }, 4000);
    } else {
