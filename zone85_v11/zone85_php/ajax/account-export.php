<?php
// ajax/account-export.php â€” Export RGPD donnÃ©es utilisateur (JSON)
...
if (!$pdo) {
    ...
    die('Base de donnÃ©es indisponible.');
}
...
try {
    ...
    die('Erreur lors de la rÃ©cupÃ©ration des donnÃ©es.');
}
