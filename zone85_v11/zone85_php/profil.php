  ...
  <div class="profil-layout">
    ...
    <aside class="profil-sidebar">
      ...
      <div class="sidebar-axe sidebar-axe-clan" onclick="switchTab('profil','activite')" role="button" tabindex="0" title="Voir mon activité">
        ...
        <div class="sidebar-axe-val sidebar-axe-val-clan">+<?= number_format((int)$user['season_pts'], 0, ',', ' ') ?> pts</div>
        <div class="sidebar-axe-sub">apportés au <?= e($user['clan_label']) ?><?php if (!empty($active_season['title'])): ?> — <?= e($active_season['title']) ?><?php endif; ?></div>
